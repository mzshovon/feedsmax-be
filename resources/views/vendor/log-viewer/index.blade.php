...
<head>
    ...
    <!-- Style sheets-->
    <link href="{{ asset('/') }}vendor/log-viewer/app.css?id=12c5e78a91987c11d8a0cc04436541e9" rel="stylesheet" onerror="alert('app.css failed to load. Please refresh the page, re-publish Log Viewer assets, or fix routing for vendor assets.')">
</head>
